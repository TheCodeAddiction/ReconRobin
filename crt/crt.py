...
def get_all_domains(url, domain_name):
    ...
    file_helper.write_list_to_file(domain_name+"_crt_domains.txt", unique_domains, "writing crt.sh domains to file",domain_name)
